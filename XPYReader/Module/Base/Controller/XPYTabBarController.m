...
- (void)viewDidLoad {
    ...
    stackNavigation.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"阅读室" image:[[UIImage imageNamed:@"匹配0"] imageWithRenderingMode: UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"匹配1"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
